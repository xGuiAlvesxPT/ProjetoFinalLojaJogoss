...
class TabelaFuncionarios(val db: SQLiteDatabase?) {
    ...
    fun cria (){
        ...
        db?.execSQL("CREATE TABLE $NOME (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT,$NOME_FUNCIONARIO TEXT(30) NOT NULL,$NIF_FUNCIONARIO NUMBER(9) NOT NULL ,$CONTACTO NUMBER(9) NOT NULL ,$DATA_DE_NASCIMENTO DATE NOT NULL) ")
    }
